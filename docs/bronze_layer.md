...
| `ed_bronze_int_subs_kafka__events`  | `LOWER(condition_name) = 'erectile dysfunction' AND event_name IN ('upcoming_term_renewal_notified', 'term_renewal_time_changed', 'condition_subscription_prescription_written', 'cancellation_intent_declared', 'condition_subscription_new_prescription_required', 'plan_change_requested', 'clinician_plan_approved', 'order_fulfillment_confirmed', 'canceled', 'cancellation_intent_revoked')` | 07/09/2026 |
...
| `int_subs_kafka__events` | `int_subs_kafka__events_07092026.sql` |
